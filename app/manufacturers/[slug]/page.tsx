        ...
        <div className="shell brand-hero">
          <div>
            ...
            <div className="brand-hero-actions">
              <RequestCta defaultProduct={displayName} requestContext={`Manufacturer: ${displayName}`} requestType="equipment" source="manufacturer_page">Request an Offer</RequestCta>
