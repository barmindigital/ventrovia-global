...
export const metadata: Metadata = {
  ...
  title: {
    default: "Промснабжение — промышленное оборудование и комплектующие",
    template: "%s | Промснабжение",
  },
  description:
  ...
  openGraph: {
    type: "website",
    locale: "ru_RU",
    siteName: "Промснабжение",
    title: "Промснабжение — промышленное оборудование",
    description:
