...
const companyHistory = [
  ...
  },
  {
    year: "2017",
    description:
      "— сеть наших партнерских проектов растет. К нам поступают предложения открыть офисы нашей компании в других округах России. Объем контейнеров увеличивается до 800 шт/месяц.",
  },
  {
    year: "2018",
    description:
      "— «Индустрия поставок» открывает филиалы в Санкт-Петербурге, Владивостоке. Объем контейнеров увеличивается от 2000 шт/месяц за счет близкого к Китаю офиса во Владивостоке.",
  },
  {
    year: "2020",
    description:
