    ...
    <>
      ...
      <section className="section shell">
        <div className="content-grid">
          ...
          <article className="value-card"><span>03</span><h2>International coordination</h2><p>Aihamyn Hampa Trading supports industrial sourcing and supply coordination for requirements serving customers worldwide.</p></article>
        </div>
      </section>
      <section className="section section-tint">
        <div className="shell brand-sections">
          ...
          <article className="content-card">
            <p>Aihamyn Hampa Trading is based in {SITE_BRAND.baseLocation} and operates with a worldwide market focus. We help procurement teams structure enquiries for industrial equipment, components and hard-to-find requirements.</p>
