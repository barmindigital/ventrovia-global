...
the start of Sprint 16 to 348 in the current validated source. The latest
factory continuation began at 178 and added 170 `BRAND_SAFE` profiles while
...
| BRAND_SAFE | 146 | 348 |
| BRAND_WEAK | 2,652 | 2,427 |
| BRAND_REVIEW | 8 | 31 |
| Manufacturer sitemap target | 146 | 348 |
| Product sitemap | 0 | 0 |
| BRAND_SAFE with logo | 102 | 115 |
| BRAND_COMPLETE | 120 | 292 |
| English short descriptions | 146 | 348 |
| English full descriptions | 146 | 348 |
| Official domains | 146 | 348 |
| Tier A source records | 245 | 606 |
| Family-evidence brands | 130 | 332 |
| Countries confirmed | — | 281 |
...
Wave 14 added: Regina Group, SCANCON, Stromag, von Rohr Armaturen, BEGE
Aandrijftechniek, COMARME, Helmut Fischer, Graymills, KRAL, NAVCO,
Pompetravaini, Schechtl, SIREM, SWEP, TOREX, Bauer Gear Motor, Bonetti, Busch
Vacuum Solutions, DESMI, DRASTAR, EBAWE, LÜBBERING, MGM Electric Motors and
Moog GAT.
...
- `international-brand-semantic-map.json`: all 348 safe brands with confirmed
...
- `processing-metrics.json`: 379 historically processed source records,
  348 safe and 31 review, 91.82% source-to-safe yield, and 1.74 sources per
...
- 348 indexable pages have unique English titles and meta descriptions.
- The word-trigram Jaccard audit compared all 60,378 `BRAND_SAFE` pairs at a
  0.72 threshold and found zero near-duplicate pairs.
- The deterministic sample contains all 348 safe pages.
...
The strongest evidence-backed future editorial candidates are pumps (94 safe
brands), automation and control (76), industrial valves and flow control
(62), industrial sensors (58), drive and motion control (56), measurement and
instrumentation (55), electric motors (47), and filtration and water systems
(32). These are
reports only: no Brand × Category or public category pages were created.

## Deployment boundary

The current validated local source targets 348 manufacturer URLs. The existing
